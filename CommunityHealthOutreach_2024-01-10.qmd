...
The point here is that a person received the service from thier HH, or from someone else.
```{r}
...
# Check it out cuz Ice is Ryhmin'
Checkit <-
  CHO_Roster2 |> 
  select(c(1, 11, 10, 33, 35, 57, 58)
...
# Select variables
selected_vars <- c("AHCCCSID", "Zcd_Z55", "Zcd_Z56", "Zcd_Z57", "Zcd_Z59", "Zcd_Z60", "Zcd_Z62", "Zcd_Z63", "Zcd_Z64", "Zcd_Z65", "Zcd_Z75")

# Group by AHCCCSID and collapse data
...
# Write to csv
write.csv(CHO_Roster3, "./data/output/CHO_Roster3.csv")
