...
Remove all items from environment except...
  - rm(list = setdiff(ls(), c("AllianceEnrolledMembers", "Claims_AllHCA", "ContractMeasures", "Data_VBPQR_AllRecords", "HHPrescriberNPI", "InpatientCensus", "MyHEDIS2023_AllValueSetsToCodes", "MyHEDIS2023_MedicationDirectory", "NAZ_Counties", "Provider_ShortName", "ProviderTIN", VBPTrendReport_colnames", "Z_Codes")))
